...
import 'package:pink/utilities/methods.dart';
...
class _SignupState extends State<Signup> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    animation2 =
        Tween<double>(begin: .02, end: .04).animate(
          CurvedAnimation(parent: controller1, curve: Curves.easeInOut),
        )..addListener(() {
          setState(() {});
        });
    ...
    animation4 =
        Tween<double>(begin: 170, end: 190).animate(
          CurvedAnimation(parent: controller2, curve: Curves.easeInOut),
        )..addListener(() {
          setState(() {});
        });
              ...
              child: Stack(
                children: [
                  Positioned(
                    ...
                    left: size.width * .21,
                    child: CustomPaint(painter: MyPainter(40)),
                  ),
                  Positioned(
                    top: size.height * .98,
                    left: size.width * .1,
