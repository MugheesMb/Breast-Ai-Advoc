...
import 'package:pink/screens/survivors.dart';
                ...
                Row(
                  ...
                  children: [
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("Consultation", style: TextStyle(fontSize: 25)),
                        Text("With Doctor", style: TextStyle(fontSize: 20)),
                      ],
                    ),
                    GestureDetector(
                      onTap: () => Get.to(() => Doctor()),
                ...
                Row(
                  ...
                  children: [
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("Meet", style: TextStyle(fontSize: 25)),
                        Text("With Survivors", style: TextStyle(fontSize: 20)),
                      ],
                    ),
                    GestureDetector(
                ...
                Row(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        Text("Meet", style: TextStyle(fontSize: 25)),
                        Text("With Friends", style: TextStyle(fontSize: 20)),
                      ],
                    ),
                    GestureDetector(
                      onTap: () {
